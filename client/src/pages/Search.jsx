...
export default function Search() {
    ...
    const handleImport = async (book) => {
        ...
        try {
            await api.post('/books/import', { gutenbergId });
                    ...
                    {results.map((book) => (
                        <BookCard
                            ...
                            book={{
                                ...
                                // Берем первое резюме книги в качестве описания, если оно есть
                                description: book.summaries && book.summaries.length > 0 ? book.summaries[0] : null
                            }}
